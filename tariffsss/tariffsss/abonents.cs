...
namespace tariffsss
{
    public partial class abonents : MaterialSkin.Controls.MaterialForm
    {
        public abonents()
        {
            InitializeComponent();
        ...
        public void down() {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("slAbonents", con);
        ...
        private void adAbonentsBtn_Click(object sender, EventArgs e)
        {
                ...
                myConn.Open();
                MySqlCommand cmd = new MySqlCommand("call addAbonents(@fam, @mobphone)", myConn);
                ...
                QT = cmd.Parameters.Add("mobphone", MySqlDbType.VarChar, 45);
        ...
        private void materialRaisedButton2_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection myConn = new MySqlConnection(myConnection);
            myConn.Open();
            MySqlCommand cmd = new MySqlCommand("call dellAbonents(@id)", myConn);
        ...
        private void materialRaisedButton3_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection myConn = new MySqlConnection(myConnection);
            myConn.Open();
            MySqlCommand cmd = new MySqlCommand("call updAbonents(@id, @fam, @mobphone)", myConn);
            ...
            DC = cmd.Parameters.Add("fam", MySqlDbType.VarChar, 45);
            ...
            MU = cmd.Parameters.Add("mobphone", MySqlDbType.VarChar, 45);
